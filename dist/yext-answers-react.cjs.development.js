  ...
  switch (action.type) {
    ...
    case 'SET_VERTICAL_RESPONSE':
      ...
      return _extends({}, state, {
        ...
        entities: response.verticalResults.results.map(function (r) {
          return r.rawData;
        }),
    ...
    case 'SET_AUTOCOMPLETE':
      ...
      return _extends({}, state, {
        autocomplete: {
          ...
          }), querySuggestions.map(function (s) {
            return _extends({}, s, {
              type: 'SUGGESTION'
            });
          }))
    ...
    case 'APPEND_ENTITIES':
      return _extends({}, state, {
        entities: [].concat(state.entities, action.entities)
      });
...
var toggleFacetObject = function toggleFacetObject(facets, facetFieldId, optionDisplayName) {
  ...
  updatedFacets.forEach(function (f) {
...
var useAnswersStore = function useAnswersStore() {
  ...
  var runSearch = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(searchTerm) {
      var res;
  ...
  var handleSearchTermChange = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(searchTerm) {
      var res;
    ...
    return function handleSearchTermChange(_x2) {
      return _ref2.apply(this, arguments);
    };
  }();

  var updateSortBys = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(sortBys, updateSearchResults) {
      var res;
    ...
    return function updateSortBys(_x3, _x4) {
      return _ref3.apply(this, arguments);
    };
  }();

  var toggleFacet = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(facetFieldId, optionDisplayName, updateSearchResults) {
      var updatedFacets, res;
    ...
    return function toggleFacet(_x5, _x6, _x7) {
          ...
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              dispatch({
                ...
                entities: res.verticalResults.results.map(function (r) {
                  return r.rawData;
                })
              });
...
var AnswersContext = function AnswersContext(props) {
  return React__default.createElement(AnswersStore, null, React__default.createElement(Inner, Object.assign({}, props)));
};
...
var Inner = function Inner(_ref) {
  ...
  var _useAnswersStore = useAnswersStore(),
      state = _useAnswersStore.state,
      _useAnswersStore$acti = _useAnswersStore.actions,
      runSearch = _useAnswersStore$acti.runSearch,
      setConfiguration = _useAnswersStore$acti.setConfiguration;
...
exports.useAnswers = useAnswersStore;
